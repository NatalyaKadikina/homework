package ru.hogwarts.school.modelTest;
...
public class ApplicationMvcTests {
    ...
    public void testGetFacultiesByColor() throws Exception {
        ...
        when(facultyRepositories.findByColor(COLOR)).thenReturn(Set.of(faculty1, faculty2));
    ...
    public void testFindFacultiesByNameOrColor() throws Exception {
        ...
        when(facultyRepositories.findFacultyByColorIgnoreCaseOrNameIgnoreCase(SEARCH_STR, SEARCH_STR)).thenReturn(Set.of(faculty1, faculty2));
